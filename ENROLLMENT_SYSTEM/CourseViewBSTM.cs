...
namespace Enrollment_System
{
    public partial class CourseViewBSTM : Form
    {
        ...
        public CourseViewBSTM(FormCourse form)
        {
            ...
            this.FormClosing += CourseViewBSTM_FormClosing;
        }

        private void BtnBack_Click(object sender, EventArgs e) => this.Close();
        private void BtnBack1_Click(object sender, EventArgs e) => this.Close();

        private void CourseViewBSTM_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void BtnEnroll1_Click(object sender, EventArgs e)
        {
            ...
            if (!ConfirmCourseSelection("BSCS", "Bachelor of Science in Tourism Management"))
                return;
        ...
        private void HandleEnrollmentCompletion()
        {
            ...
            if (parentForm.Panel8.Tag?.ToString() == "BSTM") { parentForm.UpdateCourseBannerImage("BSTM"); }
                

            parentForm.Show();

            //enrollmentForm?.Close();
           // enrollmentForm = null;
