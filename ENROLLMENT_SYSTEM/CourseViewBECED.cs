    ...
    public partial class CourseViewBECED : Form
    {
        ...
        private void BtnEnroll1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!ConfirmCourseSelection("BECED", "Bachelor of Early Childhood Education"))
                    return;
        ...
        private void HandleEnrollmentCompletion(FormCourse mainParent)
        {
            ...
            try
            {
                ...
                var courseForm = new CourseBECED
                {
                    TopLevel = false,
                    Dock = DockStyle.Fill
                };
                ...
                if (mainParent.Panel8.Tag?.ToString() == "BECED")
                    mainParent.UpdateCourseBannerImage("BECED");
            }
            catch (ObjectDisposedException)
            {
